...
with DAG(
    ...
    create_temp_bucket = GCSCreateBucketOperator(
        ...
        bucket_name = "bucket_2_composer_dataproc",
    ...
    move_objects_to_temp_bucket = GCSToGCSOperator(
        ...
        source_bucket = "bucket_1_composer_dataproc",
        source_object = "*.txt",
        destination_bucket = "bucket_2_composer_dataproc",
        move_object=True,
    ...
    copy_objects_to_datalake = GCSToGCSOperator(
        ...
        source_bucket = "bucket_2_composer_dataproc",
        source_object = "*.txt",
        destination_bucket = "bucket_3_composer_dataproc",
        # gcp_conn_id='google_cloud_default',
    )
    ...
    with TaskGroup(group_id='execute_dataproc_job') as execute_dataproc_job:
        ...
        # DataprocSubmitPySparkJobOperator(
            task_id = "submit_job",
            # main = "gs://bucket_1_composer_dataproc/job.py",
            # cluster_name = "cluster-1-composer",
