...
if __name__ == "__main__":
    ...
    # Get bucket files
    file_regex = f"gs://bucket_2_composer_dataproc/{datetime.now().strftime('%Y/%m/%d')}/*.txt"
    ...
    for path in files:
        ...
        lettersCounts.toDF(schema=['path','letters','total']) \
            ...
            .option('table', '<PROJECT_ID>.DATAPROC.test') \
            .option("temporaryGcsBucket", "bucket_2_composer_dataproc") \
            .mode('append') \
            .save()
